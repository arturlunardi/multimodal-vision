...
def process_images(
    ...
    # move the channel dimension to first dimension. The model expects images in the format [Channel, Height, Width]
...
class PaliGemmaProcessor:
    ...
    def __call__(
        ...
        # convert the list of np arrays to a single np array with shape [b_size, channels, height, width]
